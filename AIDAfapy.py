...
for record in SeqIO.parse(file, "fasta"):#file
    ...
    for i in aaindex_listT:
        a_a = ((record.seq.count("A") * i["A"])) / len(record.seq)
        c_c = ((record.seq.count("C") * i["C"])) / len(record.seq)
        d_d = ((record.seq.count("D") * i["D"])) / len(record.seq)
        e_e = ((record.seq.count("E") * i["E"])) / len(record.seq)
        f_f = ((record.seq.count("F") * i["F"])) / len(record.seq)
        g_g = ((record.seq.count("G") * i["G"])) / len(record.seq)
        h_h = ((record.seq.count("H") * i["H"])) / len(record.seq)
        i_i = ((record.seq.count("I") * i["I"])) / len(record.seq)
        k_k = ((record.seq.count("K") * i["K"])) / len(record.seq)
        l_l = ((record.seq.count("L") * i["L"])) / len(record.seq)
        m_m = ((record.seq.count("M") * i["M"])) / len(record.seq)
        n_n = ((record.seq.count("N") * i["N"])) / len(record.seq)
        p_p = ((record.seq.count("P") * i["P"])) / len(record.seq)
        q_q = ((record.seq.count("Q") * i["Q"])) / len(record.seq)
        r_r = ((record.seq.count("R") * i["R"])) / len(record.seq)
        s_s = ((record.seq.count("S") * i["S"])) / len(record.seq)
        t_t = ((record.seq.count("T") * i["T"])) / len(record.seq)
        v_v = ((record.seq.count("V") * i["V"])) / len(record.seq)
        w_w = ((record.seq.count("W") * i["W"])) / len(record.seq)
        y_y = ((record.seq.count("Y") * i["Y"])) / len(record.seq)
